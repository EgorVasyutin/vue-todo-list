...
export default {
  ...
  computed: {
    ...
    isPasswordValidSignIn() {
      return this.signInForm.password.length >= 6;
    },
    isFormValidSignIn() {
      return this.isEmailValidSignIn && this.isPasswordValidSignIn;
    },
    isEmailValidSignUp() {
      return (
        this.signUpForm.email.includes(".com") ||
        this.signUpForm.email.includes(".ru")
      );
    },
    ...
    isFormValidSignUp() {
      return this.isEmailValidSignUp && this.isPasswordValidSignUp;
    },
  },
  methods: {
    logout() {
